...
public class UserDao implements IUserDao {
    ...
    private String jdbcPassword = "Gau1002@";
    ...
    protected Connection getConnection() {
        ...
        try {
            ...
            String jdbcURL = "jdbc:mysql://localhost:3306/Caodemo?users=false";
    ...
    public List<User> searchUser(String country) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                String name = rs.getString("name");
                String email = rs.getString("email");
                String countrySearch = rs.getString("country");
                users.add(new User(id, name, email, countrySearch));
            }
        } catch (SQLException e) {
            printSQLException(e);
        }
